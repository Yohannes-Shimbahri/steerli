...
export default function ContactPage() {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 sm:gap-12">
            ...
            <div className="space-y-6 sm:space-y-8">
                ...
                {[
                  ...
                  return (
                    <div key={idx} className="flex items-start space-x-3 sm:space-x-4 group">
                      <div className={`bg-${item.color}-100 p-2 sm:p-3 rounded-lg group-hover:scale-110 transition-transform`}>
                        <Icon className={`w-5 h-5 sm:w-6 sm:h-6 text-${item.color}-600`} />
                      </div>
                      <div>
                        <h3 className="font-semibold text-gray-900 mb-1 text-sm sm:text-base">{item.title}</h3>
                        <p className="text-gray-600 whitespace-pre-line text-sm sm:text-base">{item.value}</p>
                      </div>
                    </div>
                  );
                })}
              ...
              <div className="bg-gradient-to-br from-indigo-50 to-purple-50 p-4 sm:p-6 rounded-xl">
                <h3 className="font-semibold text-gray-900 mb-2 text-sm sm:text-base">Support Hours</h3>
            ...
            <div className="lg:col-span-2">
              <div className="bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 shadow-sm hover:shadow-md transition-shadow">
                ...
                {submitted && (
                  <div className="mb-6 bg-green-50 border border-green-200 text-green-800 px-4 py-3 rounded-lg flex items-center space-x-2 animate-slideUp text-sm sm:text-base">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border ${errors.name ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-colors`}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        className={`w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border ${errors.email ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-colors`}
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border ${errors.subject ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-colors`}
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows="6"
                  className={`w-full px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base border ${errors.message ? 'border-red-500' : 'border-gray-300'} rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none transition-colors resize-none`}
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-lg hover:from-indigo-700 hover:to-purple-700 transition-all text-base sm:text-lg font-semibold shadow-lg flex items-center justify-center space-x-2 transform hover:scale-105"
              >
  ...
  <section className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-indigo-50 to-purple-50">
    <div className="max-w-7xl mx-auto text-center">
      <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">Looking for Quick Answers?</h2>
      <p className="text-sm sm:text-base text-gray-600 mb-6 sm:mb-8">Check out our FAQ page for common questions</p>
      <a href="/faq" className="inline-block bg-white text-indigo-600 px-6 sm:px-8 py-2 sm:py-3 rounded-lg hover:bg-gray-50 transition-all font-semibold border border-indigo-200 transform hover:scale-105 text-sm sm:text-base">
        View FAQ
      </a>
    </div>
  </section>
