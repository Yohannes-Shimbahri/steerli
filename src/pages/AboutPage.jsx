      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-indigo-100 to-purple-100 rounded-2xl p-12 flex items-center justify-center transform hover:scale-105 transition-transform duration-300">
              <Heart className="w-64 h-64 text-indigo-600 opacity-20" />
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              return (
                <div key={idx} className="bg-white p-8 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 transform hover:-translate-y-2">
                  <Icon className={`w-12 h-12 text-${value.color}-600 mb-4`} />
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href={`${APP_URL}/auth/sign-up?type=student`} className="bg-indigo-600 text-white px-8 py-4 rounded-lg hover:bg-indigo-700 transition-all text-lg font-semibold shadow-lg transform hover:scale-105">
              Sign Up as Student
            </a>
            <a href={`${APP_URL}/auth/sign-up?type=instructor`} className="bg-purple-600 text-white px-8 py-4 rounded-lg hover:bg-purple-700 transition-all text-lg font-semibold shadow-lg transform hover:scale-105">
