    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <section id="for-students" className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 bg-black/50">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-12 sm:mt-16 animate-slide-in-up" style={{animationDelay: '0.6s'}}>
            <a href={`${APP_URL}/auth/sign-up/student`} className="inline-block bg-purple-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl hover:bg-purple-700 transition-all text-base sm:text-lg font-semibold shadow-lg shadow-purple-900/50 transform hover:scale-105">
      ...
      <section id="for-instructors" className="py-12 sm:py-20 px-4 sm:px-6 lg:px-8 bg-[#0a0a0a]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-12 sm:mt-16 animate-slide-in-up" style={{animationDelay: '0.6s'}}>
            <a href={`${APP_URL}/auth/sign-up/instructor`} className="inline-block bg-indigo-600 text-white px-6 sm:px-8 py-3 sm:py-4 rounded-xl hover:bg-indigo-700 transition-all text-base sm:text-lg font-semibold shadow-lg shadow-indigo-900/50 transform hover:scale-105">
